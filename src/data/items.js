export const ITEMS = [
  ...
  { id:'herbs',        name:'Herbs',         tier:'c', emoji:'🌿', type:'mat', heal:2 },
  { id:'rare_herbs',   name:'Rare Herbs',    tier:'u', emoji:'🌱', type:'mat' },
  { id:'pale_fungus',  name:'Pale Fungus',   tier:'u', emoji:'🍄', type:'mat', heal:3 },
  { id:'bitterroot',   name:'Bitterroot',    tier:'u', emoji:'🥀', type:'mat' },
  { id:'ironweed',     name:'Ironweed',      tier:'u', emoji:'🌾', type:'mat' },
  { id:'nightshade',   name:'Nightshade',    tier:'r', emoji:'🫐', type:'mat', heal:5, poisonChance:0.2 },
  { id:'embermoss',    name:'Embermoss',     tier:'u', emoji:'🔥', type:'mat' },
  { id:'rare_crystal', name:'Rare Crystal',  tier:'r', emoji:'💠', type:'mat', desc:'Arcane-tier crafting material from caves and tundra' },
  { id:'preserved_food', name:'Preserved Food', tier:'u', emoji:'🥫', type:'mat', heal:4 },
